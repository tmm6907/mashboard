...
<div class="bg-base-300 box w-full">
  ...
  <ul class="menu mb-2 w-full">
    ...
    <li>
      <a href="#saved/" onclick={() => appState.currentPage.push("#saved/")}>
